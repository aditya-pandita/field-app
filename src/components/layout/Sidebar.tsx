...
const navItems = [
  ...
  { href: '/calendar',   label: 'CALENDAR',   icon: CalendarDays, num: '05' },
  { href: "/live",       label: "LIVE",        icon: Mic,          num: "06", isLive: true },
  { href: "/analytics", label: "ANALYTICS", icon: BarChart2,    num: "07" },
  { href: "/program",   label: "PROGRAM",   icon: Trophy,       num: "08" },
  { href: "/trainer",   label: "TRAINER",   icon: Zap,          num: "09" },
  { href: "/scenario",  label: "SCENARIO",  icon: MessageSquare,num: "10" },
  { href: "/adversary", label: "ADVERSARY", icon: Shield,       num: "11", isAdversary: true },
  { href: "/flashcards",label: "CARDS",     icon: Layers,       num: "12" },
  { href: "/coaches",   label: "COACHES",   icon: Users,        num: "13" },
  { href: '/reference', label: 'REFERENCE', icon: BookMarked,   num: '14' },
  { href: '/pipeline',  label: 'PIPELINE',  icon: Kanban,       num: '15' },
];
